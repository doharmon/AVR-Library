...
#define uart_flushOuput() uart0_flushOutput()
...
/**
 *  @brief   Flush bytes waiting in transmit buffer
 */
extern void uart0_flushOutput(void);

/**
 *  @brief   Returns overflow status of receive ringbuffer then clears status.
 *  @return  number of bytes in ringbuffer
 */
extern uint8_t uart0_overflow(void);
...
/** @brief   Flush bytes waiting in transmit buffer */
extern void uart1_flushOutput(void);
/**  @brief   Returns overflow status of receive ringbuffer then clears status. */
extern uint8_t uart1_overflow(void);
...
/** @brief   Flush bytes waiting in transmit buffer */
extern void uart2_flushOuput(void);
/**  @brief   Returns overflow status of receive ringbuffer then clears status. */
extern uint8_t uart2_overflow(void);
...
/** @brief   Flush bytes waiting in transmit buffer */
extern void uart3_flushOutput(void);
/**  @brief   Returns overflow status of receive ringbuffer then clears status. */
extern uint8_t uart3_overflow(void);
