...
void uart0_putc(uint8_t data)
{
	...
	#ifdef	Timer_H_
	WAIT_TILL_FALSE_RETURN(tmphead == UART_TxTail,5);
	#else
	#warning "uart0_putc can hang. Include Timer.h in uart.c"
...
{
	return (UART_RxHead - UART_RxTail) & UART_RX0_BUFFER_MASK;
} /* uart0_available */
...
/*************************************************************************
Function: uart0_flushOutput()
Purpose:  Flush bytes waiting in the transmit buffer.
Input:    None
Returns:  None
**************************************************************************/
void uart0_flushOutput(void)
{
	#warning "uart0_flushOutput can hang"
...
/*************************************************************************
Function: uart0_overflow()
Purpose:  Returns overflow status of receive buffer then clears status.
Input:    None
Returns:  Integer non zero if receive buffer overflowed
**************************************************************************/
uint8_t uart0_overflow(void)
{
  uint8_t ret;

  ret = UART_LastRxError & UART_BUFFER_OVERFLOW >> 8;
...
{
	return (UART1_RxHead - UART1_RxTail) & UART_RX1_BUFFER_MASK;
} /* uart1_available */
...
/*************************************************************************
Function: uart1_flushOutput()
Purpose:  Flush bytes waiting in the transmit buffer.
Input:    None
Returns:  None
**************************************************************************/
void uart1_flushOutput(void)
{
	#warning "uart1_flushOutput can hang"
	while(UART1_TxHead != UART1_TxTail)
		;
} /* uart1_flushOutput */

/*************************************************************************
Function: uart1_overflow()
Purpose:  Returns overflow status of receive buffer then clears status.
Input:    None
Returns:  Integer non zero if receive buffer overflowed
**************************************************************************/
uint8_t uart1_overflow(void)
{
	uint8_t ret;

	ret = UART1_LastRxError & UART_BUFFER_OVERFLOW >> 8;
...
void uart2_putc(uint8_t data)
{
	...
	/* Wait for free space in buffer */
	WAIT_TILL_FALSE_RETURN(tmphead == UART2_TxTail,5);
...
{
	return (UART2_RxHead - UART2_RxTail) & UART_RX2_BUFFER_MASK;
} /* uart2_available */
...
/*************************************************************************
Function: uart2_flushOutput()
Purpose:  Flush bytes waiting in the transmit buffer.
Input:    None
Returns:  None
**************************************************************************/
void uart2_flushOutput(void)
{
	#warning "uart2_flushOutput can hang"
	while(UART2_TxHead != UART2_TxTail)
	;
	} /* uart2_flushOutput */

/*************************************************************************
Function: uart2_overflow()
Purpose:  Returns overflow status of receive buffer then clears status.
Input:    None
Returns:  Integer non zero if receive buffer overflowed
**************************************************************************/
uint8_t uart2_overflow(void)
{
	uint8_t ret;

	ret = UART2_LastRxError & UART_BUFFER_OVERFLOW >> 8;
	UART2_LastRxError &= ~(UART_BUFFER_OVERFLOW >> 8);
...
void uart3_putc(uint8_t data)
{
	...
	/* Wait for free space in buffer */
	WAIT_TILL_FALSE_RETURN(tmphead == UART3_TxTail,5);
...
{
	return (UART3_RxHead - UART3_RxTail) & UART_RX3_BUFFER_MASK;
} /* uart3_available */
...
/*************************************************************************
Function: uart3_flushOutput()
Purpose:  Flush bytes waiting in the transmit buffer.
Input:    None
Returns:  None
**************************************************************************/
void uart3_flushOutput(void)
{
	#warning "uart3_flushOutput can hang"
	while(UART3_TxHead != UART3_TxTail)
	;
	} /* uart3_flushOutput */

/*************************************************************************
Function: uart3_overflow()
Purpose:  Returns overflow status of receive buffer then clears status.
Input:    None
Returns:  Integer non zero if receive buffer overflowed
**************************************************************************/
uint8_t uart3_overflow(void)
{
	uint8_t ret;

	ret = UART3_LastRxError & UART_BUFFER_OVERFLOW >> 8;
	UART3_LastRxError &= ~(UART_BUFFER_OVERFLOW >> 8);
